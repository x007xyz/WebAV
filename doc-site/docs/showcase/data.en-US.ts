  ...
  list: [
    {
      ...
      description:
        'A commercial SDK extended from WebAV, helping users quickly build web-based audio and video products.',
    ...
    },
    {
      ...
      description:
        'Based on WebAV Pro, a video editing tool for businesses and merchants to quickly edit videos.',
